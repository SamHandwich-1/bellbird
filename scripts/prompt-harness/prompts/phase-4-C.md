...
DISCARD threshold is high — preserves the "if anything can be killed, nothing is" discipline. DISCARD is reserved for the two conditions named above (contrarian argument breaks the structural premise; picks-and-shovels insight is already priced), not a default for any thesis that smells underdeveloped.
